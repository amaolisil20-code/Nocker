    ...
    Alert.alert(
      ...
      [
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              // Marca a próxima parcela como paga E cria a despesa correspondente
              // em uma única chamada atômica no backend (evita duplicar transações).
              await api.payInstallment(item.id);
