...
const GOOGLE_LOGIN_CONFIGURED = Boolean(SUPABASE_URL && SUPABASE_ANON_KEY);
// Cliente "dummy" quando as env vars não estão configuradas, só para não
// quebrar o import — o botão de login com Google fica desabilitado nesse caso
// (ver handleGoogleLogin) em vez de falhar silenciosamente em runtime.
  ...
  const handleGoogleLogin = async () => {
    if (!GOOGLE_LOGIN_CONFIGURED) {
      Alert.alert(
        ...
        'Configure EXPO_PUBLIC_SUPABASE_URL e EXPO_PUBLIC_SUPABASE_ANON_KEY no .env do app para habilitar o login com Google.',
      );
      return;
    }
    setGoogleBusy(true);
