...
const translations = {
  pt: {
    ...
    aiAssistantHint: 'Personalidade, tom e chat financeiro',
  ...
  en: {
    ...
    aiAssistantHint: 'Personality, tone and financial chat',
  ...
  es: {
    ...
    aiAssistantHint: 'Personalidad, tono y chat financiero',
